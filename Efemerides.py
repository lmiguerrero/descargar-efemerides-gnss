...
# --- CSS para un diseño más moderno (Tarjeta y Paleta de Colores) ---
st.markdown(
    """
    <style>
    .stApp {
...
# --- Contenedor para parámetros de descarga (usando st.container para el efecto de tarjeta) ---
    ...
    if st.session_state["mostrar_mapa"] and st.session_state["mapa_data"]:
        ...
        try:
            ...
            if user_coord is not None:
                ...
                # --- Se utiliza st.dataframe para una tabla más limpia ---
